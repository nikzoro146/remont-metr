...
export const SlideDecor = ({ number }: SlideDecorProps) => (
  <div className="absolute inset-0 -z-10 pointer-events-none" aria-hidden>
    ...
    />
    {/* Оранжевое пятно */}
    <div className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-orange-400/15 blur-3xl" />
    {/* Номер секции */}
    <div className="absolute top-16 right-8 font-unbounded font-bold text-[9rem] leading-none text-[#141414] opacity-[0.05] select-none">
      {number}
    </div>
    {/* Высотки */}
    <svg
      className="absolute bottom-0 left-0 w-full h-40 md:h-56 opacity-[0.06]"
